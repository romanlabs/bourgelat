                    ...
                    },
                    {
                      ...
                      render: (row) => (
                        <div className="flex flex-wrap gap-2">
                          {row.historiasTo && (
                            <Link to={row.historiasTo} className="inline-flex items-center border border-border bg-foreground px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-slate-800">
                              Historia
                            </Link>
                          )}
                          {row.antecedentesTo && (
